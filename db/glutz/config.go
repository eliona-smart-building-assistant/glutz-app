...
type Config struct {
	...
	DefaultOpenableDuration null.Int32        `boil:"default_openable_duration" json:"default_openable_duration,omitempty" toml:"default_openable_duration" yaml:"default_openable_duration,omitempty"`
	Initialized             null.Bool         `boil:"initialized" json:"initialized,omitempty" toml:"initialized" yaml:"initialized,omitempty"`
...
var ConfigColumns = struct {
	...
	DefaultOpenableDuration string
	Initialized             string
	ProjectIds              string
}{
	ConfigID:                "config_id",
	...
	DefaultOpenableDuration: "default_openable_duration",
...
var ConfigTableColumns = struct {
	...
	DefaultOpenableDuration: "config.default_openable_duration",
...
var ConfigWhere = struct {
	...
	DefaultOpenableDuration whereHelpernull_Int32
	Initialized             whereHelpernull_Bool
	...
	RequestTimeout:          whereHelpernull_Int32{field: "\"glutz\".\"config\".\"request_timeout\""},
	RefreshInterval:         whereHelpernull_Int32{field: "\"glutz\".\"config\".\"refresh_interval\""},
	DefaultOpenableDuration: whereHelpernull_Int32{field: "\"glutz\".\"config\".\"default_openable_duration\""},
	Initialized:             whereHelpernull_Bool{field: "\"glutz\".\"config\".\"initialized\""},
	ProjectIds:              whereHelpertypes_StringArray{field: "\"glutz\".\"config\".\"project_ids\""},
}
...
func (q configQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Config, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbglutz: failed to execute a one query for config")
	}
...
func (q configQuery) All(ctx context.Context, exec boil.ContextExecutor) (ConfigSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbglutz: failed to assign all query results to Config slice")
	}
...
func (q configQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: failed to count config rows")
	}
...
func (q configQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbglutz: failed to check if config exists")
	}
...
func Configs(mods ...qm.QueryMod) configQuery {
	mods = append(mods, qm.From("\"glutz\".\"config\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"glutz\".\"config\".*"})
	}
...
func FindConfig(ctx context.Context, exec boil.ContextExecutor, configID int64, selectCols ...string) (*Config, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"glutz\".\"config\" where \"config_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbglutz: unable to select from config")
	}
...
func (o *Config) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbglutz: no config provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"glutz\".\"config\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"glutz\".\"config\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbglutz: unable to insert into config")
	}
...
func (o *Config) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbglutz: unable to update config, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"glutz\".\"config\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to update config row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: failed to get rows affected by update for config")
	}
...
func (q configQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to update all for config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to retrieve rows affected for config")
	}
...
func (o ConfigSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"glutz\".\"config\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to update all in config slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to retrieve rows affected all in update all config")
	}
	return rowsAff, nil
}
...
func (o *Config) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbglutz: no config provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbglutz: unable to upsert config, could not build update column list")
		}
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"glutz\".\"config\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "dbglutz: unable to upsert config")
	}
...
func (o *Config) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbglutz: no Config provided for delete")
	}
	...
	sql := "DELETE FROM \"glutz\".\"config\" WHERE \"config_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to delete from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: failed to get rows affected by delete for config")
	}
...
func (q configQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbglutz: no configQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to delete all from config")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: failed to get rows affected by deleteall for config")
	}
...
func (o ConfigSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"glutz\".\"config\" WHERE " +
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbglutz: unable to delete all from config slice")
	}
...
func (o *Config) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbglutz: no Config provided for reload")
	}
...
func (o *ConfigSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("dbglutz: empty ConfigSlice provided for reload all")
	}
...
func (o *ConfigSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"glutz\".\"config\".* FROM \"glutz\".\"config\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbglutz: unable to reload all in ConfigSlice")
	}
...
func ConfigExists(ctx context.Context, exec boil.ContextExecutor, configID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"glutz\".\"config\" where \"config_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbglutz: unable to check if config exists")
	}
